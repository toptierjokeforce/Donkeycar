...
try:
    # Path 1 PICKUP A ---> DROP OFF B
    holder = dijsktra(graph, 'A', 'I')
    runner(holder)
    zumi.turn(180)
    zumi.forward(38, 1, 180)
    zumi.turn(0)
    ...
    holder = dijsktra(graph, 'I', 'O')
    runner(holder)
    zumi.turn(272)
    zumi.forward(38, 1, 270)
    zumi.turn(5)
    time.sleep(2)

    # PATH 2 PICKUP D ---> DROP OFF E
    zumi.turn(90)
    zumi.forward(38, 0.9, 90)
    holder = dijsktra(graph, 'O', 'M')
    runner(holder)
    zumi.turn(90)
    zumi.forward(38, 1, 90)
    zumi.turn(275)
    zumi.play_note(Note.C4)
    zumi.play_note(Note.C4)

    zumi.forward(38, 1, 270)
    holder = dijsktra(graph, 'M', 'Z')
    runner(holder)
    zumi.turn(270)
    zumi.forward(38, 1, 270)
    zumi.turn(5)
    ...
    # PATH 3 PICKUP A ---> DROP OFF C
    zumi.turn(86)
    zumi.forward(38, 0.8, 90)
    holder = dijsktra(graph, 'Z', 'I')
    runner(holder)
    zumi.turn(180)
    zumi.forward(38, 1, 180)
    zumi.turn(0)
